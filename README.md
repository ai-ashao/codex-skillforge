...
| [`reference-website-builder`](skills/reference-website-builder/) | Reconstructing an explicitly provided page inside an existing product before safely adapting it. | Page-scoped evidence templates, a required design-language contract, temporary-asset isolation, centralized asset mapping, validation tooling, and a production release gate. |
